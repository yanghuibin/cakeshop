<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:87:"/home/wwwroot/cake.huayishang.net/public/../application/admin/view/category/detail.html";i:1577474690;s:29:"static/admin/common/head.html";i:1577181171;s:31:"static/admin/common/navbar.html";i:1575735786;s:32:"static/admin/common/sidebar.html";i:1576690634;s:29:"static/admin/common/foot.html";i:1575741086;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form class="form-horizontal"  enctype="multipart/form-data"  role="form" method="post" action="<?php echo url('category/edit'); ?>">
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="category_id"> 分类ID </label>

                            <div class="col-sm-9">
                                <input type="text" id="category_id" name="category_id" placeholder="分类ID" class="col-xs-10 col-sm-10"  readonly value="<?php echo $category_result['category_id']; ?>"/>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="category_name"> 分类名称 </label>

                            <div class="col-sm-9">
                                <input type="text" id="category_name" name="category_name" placeholder="分类名称" class="col-xs-10 col-sm-10"  value="<?php echo $category_result['category_name']; ?>"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="category_img"> 分类图片 </label>
                                <div class="col-sm-9">
                                    <div class="fallback dropzone well col-xs-10 col-sm-10">
                                        <img src="<?php echo $category_result['category_img']; ?>" style="width: 50px ;height: 50px">
                                        <input name="category_img" type="file"  id="category_img"  accept=".jpg, .jpeg, .png"/>参考尺寸300*300px
                                    </div>
                                    <div>
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="category_is_show"> 是否显示</label>
                            <div class="col-xs-3">
                                <label>

                                    <?php if($category_result['category_is_show'] == '1'): ?>
                                    <input name="category_is_show" id="category_is_show" class="ace ace-switch ace-switch-5" type="checkbox" value="on" checked="checked"/>
                                    <?php else: ?>
                                    <input name="category_is_show" id="category_is_show" class="ace ace-switch ace-switch-5" type="checkbox"   />
                                    <?php endif; ?>
